...
public class ProductApiGetCallLombok {
	
	@Test
	public void productGetLombok() {
		...
		try {
			ProductPOJOLombok[] responsejsonpojo = mapper.readValue(response.getBody().asString(), 
													ProductPOJOLombok[].class);
